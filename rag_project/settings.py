...
STATIC_URL = 'static/'
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')] # Commented out as it doesn't exist yet
...
CHROMA_DB_PATH = os.path.join(BASE_DIR, "chroma_db") # Path to store ChromaDB data
